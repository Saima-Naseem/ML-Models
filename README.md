...
4. **Train model**: Fit a `LinearRegression` model on the training data.
...
### Result Summary
The model shows a clear positive trend (predictions follow actual values), with moderate accuracy, typical for a simple linear model on real-world medical data with non-linear relationships.

### How to Run this Model
1. Download `linear_regression.ipynb` from this repo
